...
var _ReviewSection = __webpack_require__(13);

var _ReviewSection2 = _interopRequireDefault(_ReviewSection);

var _Goals = __webpack_require__(15);
...
exports.default = (0, _reactStatic.getSiteProps)(function () {
  return _react2.default.createElement(
    'div',
    null,
    _react2.default.createElement(_Header2.default, { name: _review2.default.name, quote: _review2.default.quote }),
    _react2.default.createElement(_Goals2.default, { number: _review2.default.number, period: _review2.default.period, goals: _review2.default.goals }),
    _react2.default.createElement(
      'ul',
      { className: 'sections-list' },
      _review2.default.sections.map(function (section) {
        return _react2.default.createElement(
          'li',
    ...
    _react2.default.createElement(_Legend2.default, { legend: _review2.default.legend })
  );
});
...
module.exports = {"legend":{"status":["planned","added","removed","not-done","blocked"]},"number":"12","period":"10. - 23.01.2018","name":"Pippi Langstrumpf","quote":"Das habe ich noch nie vorher versucht, also bin ich völlig sicher, dass ich das schaffe!","goals":["Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo","Quis enim. Donec pede justo, fringilla vel"],"sections":[{"title":"Tracking","tasks":[{"key":"AC-3629","summary":"Sed ut perspiciatis unde omnis iste natus error sit voluptatem","status":"planned"},{"key":"AC-3290","summary":"Far far away, behind the word mountains, far from the","status":"planned"},{"key":"AC-3630","summary":"A wonderful serenity has taken possession of my entire soul,","status":"added"}]},{"title":"A/B Testing","tasks":[{"key":"AC-3614","summary":"Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo","status":"planned"},{"key":"AC-3615","summary":"One morning, when Gregor Samsa woke from troubled dreams, he","status":"planned"}]},{"title":"Slots / Banner","tasks":[{"key":"AC-3399","summary":"The quick, brown fox jumps over a lazy dog. DJs","status":"planned"},{"key":"AC-3631","summary":"Far far away, behind the word mountains, far from the","status":"removed"}]},{"title":"My Account","tasks":[{"key":"AC-3612","summary":"The European languages are members of the same family.","status":"added"},{"key":"AC-3612","summary":"The quick, brown fox jumps over a lazy dog.","status":"not-done"}]}]}
...
var _logoAlodo = __webpack_require__(12);
